...
Governance note: Current owner is [Conversion tracking](../10-conversion-tracking/README.md). Update new franchise Canada tracking summaries or final tracking decisions there. Status: `Current phase evidence`.
