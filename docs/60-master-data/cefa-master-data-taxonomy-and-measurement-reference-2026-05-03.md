...
| Franchise USA QA/build | `docs/franchise-usa-phase1/01-gtm-build-and-qa-2026-05-01.md` and `02-qa-and-cutover-checklist.md` | USA GTM Version 17, helper mapping, USA Meta dataset split, legacy micro/click cleanup, remaining Ads/Meta confirmation. |
