...
| Systems checked | Live form URLs, GTM runtime scripts, GA4 Data API, GA4 Admin links, Supermetrics Google Ads reporting, WP Engine/WP-CLI, controlled live form submissions |
| Live writes made | Yes: franchise WPCode bridge attribution cleanup patch deployed to Canada and USA on 2026-05-04. |
| Platform settings changed | No GTM, GA4, Google Ads, or Meta setting changes were made during the cleanup patch. |
